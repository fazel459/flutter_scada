          ...
          Row(
            children: [
                ...
                child: Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String?>(
                      value: _selectedTag,
                      isExpanded: true,
                      hint: const Text('همه تگ‌ها', style: TextStyle(color: Color(0xFF64748B), fontSize: 11)),
              ...
              FilterChip(
                ...
                side: BorderSide(color: _showOnlyAlarms ? Colors.red : const Color(0xFF475569)),
                labelStyle: TextStyle(color: _showOnlyAlarms ? Colors.red : Colors.white70),
              ),
            ],
          ),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border(
                ...
                right: row.isAlarm ? const BorderSide(color: Colors.red, width: 3) : BorderSide.none,
              ),
            ),
            child: Row(
              children: [
                ...
                Expanded(
                  ...
                  child: GestureDetector(
                    onLongPress: () => _copyToClipboard(PersianUtils.formatDateTime(row.timestamp)),
                    child: Text(
